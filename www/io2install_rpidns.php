<?php
/**
 * ioc2rpz.gui - RpiDNS Installation Script Generator
 * 
 * This file contains the function to generate RpiDNS installation scripts
 * for bare-metal/VM deployments on Raspbian.
 * 
 * @package ioc2rpz.gui
 * @author Vadim Pavlov
 * @copyright 2018-2026
...
/**
 * Generates a complete RpiDNS installation script for bare-metal/VM deployment
 * 
 * Creates a bash script that installs and configures:
 * - ISC BIND DNS server with RPZ support
 * - OpenResty (nginx + Lua) web server
 * - SSL certificate generation (CA, intermediate, and dynamic certs)
 * - Rsyslog for DNS query logging
 * - Local RPZ zones for whitelisting/blacklisting
 * 
 * The script is designed for Raspbian 10 on Raspberry Pi devices.
 * 
 * @param SQLite3 $db Database connection handle
 * @param string $uuid RpiDNS device UUID
 * @return string Complete bash installation script
 */
function generate_install_script_rpidns($db, $uuid){ 
