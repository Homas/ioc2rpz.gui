      ...
      <span class='text-center'>
        <div>
          ...
          <b-row v-show="ftExFormat == 'Infoblox'">
            ...
            <b-col :sm="6" class="form_row"><b-input v-model.trim="rpzExportIBView" :state="validateName('rpzExportIBView')" :formatter="formatName" ref="formDNSView" placeholder="Enter DNS View"  v-b-tooltip.hover title="Network View" /></b-col>
          </b-row>
