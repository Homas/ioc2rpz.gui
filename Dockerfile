...
RUN mkdir -p /run/apache2 /etc/apache2/ssl /opt/ioc2rpz.gui/www /opt/ioc2rpz.gui/www/js /opt/ioc2rpz.gui/www/css /opt/ioc2rpz.gui/img /opt/ioc2rpz.gui/www/io2cfg \
    ...
    apk add bash openrc curl coreutils openssl apache2 libxml2-dev apache2-utils php7 php7-apache2 php7-json php7-curl apache2-ssl sqlite php7-sqlite3 php7-ctype && \
