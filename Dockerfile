#Copyright 2017-2023 Vadim Pavlov ioc2rpz[at]gmail[.]com
#
...
RUN mkdir -p /run/apache2 /etc/apache2/ssl /opt/ioc2rpz.gui/www /opt/ioc2rpz.gui/www/js /opt/ioc2rpz.gui/www/css /opt/ioc2rpz.gui/www/webfonts /opt/ioc2rpz.gui/img /opt/ioc2rpz.gui/www/io2cfg \
    ...
    apk add bash openrc curl coreutils openssl apache2 libxml2-dev apache2-utils php81 php81-apache2 php81-session php81-json php81-curl php81-pecl-ssh2 apache2-ssl sqlite php81-sqlite3 php81-ctype bind-tools knot-utils && \
